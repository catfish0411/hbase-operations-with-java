...
public class ExampleForHbase{
    ...
    public static void main(String[] args)throws IOException{
        ...
        deleteRowByColumn("Score", "95001", "course", "English");

        //删除course的两条数据
        deleteRowByFamily("Score", "95001", "course");
    ...
    public static void listTables() throws IOException {
        ...
        System.out.println("=========show all table==============");
     ...
     * @throws IOException
     */
    public static void deleteRowByFamily(String tableName,String rowKey,String colFamily) throws IOException {
        init();
        Table table = connection.getTable(TableName.valueOf(tableName));
     ...
     * @throws IOException
     */
    public static void deleteRowByColumn(String tableName,String rowKey,String colFamily,String col) throws IOException {
        init();
        Table table = connection.getTable(TableName.valueOf(tableName));
        Delete delete = new Delete(rowKey.getBytes());
        //删除指定列的数据
